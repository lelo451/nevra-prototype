...
public final class ACBrCEP extends ACBrLibBase {
    ...
    protected void dispose() throws Exception {
        int ret = ACBrCEPLib.INSTANCE.CEP_Finalizar(getLibHandler());
        checkResult(ret);
    }
    ...
    public String nome() throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_Nome(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String versao() throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_Versao(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public void configLer(String eArqConfig) throws Exception {
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigLer(getLibHandler(), toUTF8(eArqConfig));
        checkResult(ret);
    }
    ...
    public void configGravar(String eArqConfig) throws Exception {
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigGravar(getLibHandler(), toUTF8(eArqConfig));
        checkResult(ret);
    }
    ...
    public String configLerValor(ACBrSessao eSessao, String eChave) throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigLerValor(getLibHandler(), toUTF8(eSessao.name()), toUTF8(eChave), buffer, bufferLen);
        checkResult(ret);
    ...
    public void configGravarValor(ACBrSessao eSessao, String eChave, Object value) throws Exception {
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigGravarValor(getLibHandler(), toUTF8(eSessao.name()), toUTF8(eChave), toUTF8(value.toString()));
        checkResult(ret);
    }
    ...
    public String buscarPorCEP(String eCEP) throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_BuscarPorCEP(getLibHandler(), toUTF8(eCEP), buffer, bufferLen);
        checkResult(ret);
        return processResult(buffer, bufferLen);
    }
    ...
    public String buscarPorLogradouro(String eCidade, String eTipo_Logradouro, String eLogradouro, String eUF, String eBairro) throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_BuscarPorLogradouro(getLibHandler(), toUTF8(eCidade), toUTF8(eTipo_Logradouro), toUTF8(eLogradouro), toUTF8(eUF), toUTF8(eBairro),  buffer, bufferLen);
        checkResult(ret);
        return processResult(buffer, bufferLen);
    }
    ...
    public void ConfigImportar(String eArqConfig) throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigImportar(getLibHandler(), eArqConfig);
        checkResult(ret);
    }
    ...
    public String ConfigExportar() throws Exception {
        ...
        int ret = ACBrCEPLib.INSTANCE.CEP_ConfigExportar(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    protected void UltimoRetorno(ByteBuffer buffer, IntByReference bufferLen) {
        ACBrCEPLib.INSTANCE.CEP_UltimoRetorno(getLibHandler(), buffer, bufferLen);
    }
