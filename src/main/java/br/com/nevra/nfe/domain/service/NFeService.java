...
public class NFeService {
    ...
    @Value("${nfe.api.json.host}")
    private String host;
    @Value("${nfe.api.json.port}")
    private String port;
    ...
    public String carregarJSON(String path) throws Exception {
        HttpEntity<String> request = new HttpEntity<>(path);
        ResponseEntity<String> response = restTemplate.exchange(host + ":" + port + "/NFe", HttpMethod.POST, request, String.class);
