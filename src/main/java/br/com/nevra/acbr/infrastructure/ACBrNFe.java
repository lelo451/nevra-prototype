package br.com.nevra.acbr.infrastructure;

import br.com.nevra.acbr.domain.common.ACBrLibBase;
import br.com.nevra.acbr.domain.common.ACBrSessao;
import br.com.nevra.acbr.domain.common.nfe.TipoPathNFe;
...
public final class ACBrNFe extends ACBrLibBase {
    ...
    protected void dispose() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_Finalizar(getLibHandler());
        checkResult(ret);
    }
    ...
    public String nome() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Nome(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String versao() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Versao(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public void configLer(String eArqConfig) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigLer(getLibHandler(), toUTF8(eArqConfig));
        checkResult(ret);
    }
    ...
    public void configGravar(String eArqConfig) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigGravar(getLibHandler(), toUTF8(eArqConfig));
        checkResult(ret);
    }
    ...
    public String configLerValor(ACBrSessao eSessao, String eChave) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigLerValor(getLibHandler(), toUTF8(eSessao.name()), toUTF8(eChave), buffer, bufferLen);
        checkResult(ret);
    ...
    public void configGravarValor(ACBrSessao eSessao, String eChave, Object value) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigGravarValor(getLibHandler(), toUTF8(eSessao.name()), toUTF8(eChave), toUTF8(value.toString()));
        checkResult(ret);
    }

    public void carregarXml(String eArquivoOuXML) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_CarregarXML(getLibHandler(), toUTF8(eArquivoOuXML));
        checkResult(ret);
    }
    ...
    public String obterXml(int AIndex) throws Exception {
        ByteBuffer buffer = ByteBuffer.allocate(STR_BUFFER_LEN);
        IntByReference bufferLen = new IntByReference(STR_BUFFER_LEN);
        int ret = ACBrNFeLib.INSTANCE.NFE_ObterXml(getLibHandler(), AIndex, buffer, bufferLen);
        checkResult(ret);
    ...
    public void gravarXml(int AIndex, String eNomeArquivo, String ePathArquivo) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_GravarXml(getLibHandler(), AIndex, toUTF8(eNomeArquivo), toUTF8(ePathArquivo));
        checkResult(ret);
    }
    ...
    public String obterIni(int AIndex) throws Exception {
        ByteBuffer buffer = ByteBuffer.allocate(STR_BUFFER_LEN);
        IntByReference bufferLen = new IntByReference(STR_BUFFER_LEN);
        int ret = ACBrNFeLib.INSTANCE.NFE_ObterIni(getLibHandler(), AIndex, buffer, bufferLen);
        checkResult(ret);
    ...
    public void gravarIni(int AIndex, String eNomeArquivo, String ePathArquivo) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_GravarIni(getLibHandler(), AIndex, toUTF8(eNomeArquivo), toUTF8(ePathArquivo));
        checkResult(ret);
    }

    public void carregarIni(String eArquivoOuIni) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_CarregarINI(getLibHandler(), toUTF8(eArquivoOuIni));
        checkResult(ret);
    }

    public void limparLista() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_LimparLista(getLibHandler());
        checkResult(ret);
    }

    public void carregarEventoXml(String eArquivoOuXML) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_CarregarEventoXML(getLibHandler(), toUTF8(eArquivoOuXML));
        checkResult(ret);
    }

    public void carregarEventoINI(String eArquivoOuIni) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_CarregarEventoINI(getLibHandler(), toUTF8(eArquivoOuIni));
        checkResult(ret);
    }

    public void limparListaEventos() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_LimparListaEventos(getLibHandler());
        checkResult(ret);
    }

    public void assinar() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_Assinar(getLibHandler());
        checkResult(ret);
    }

    public void validar() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_Validar(getLibHandler());
        checkResult(ret);
    }
    ...
    public String validarRegrasdeNegocios() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ValidarRegrasdeNegocios(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String verificarAssinatura() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_VerificarAssinatura(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String gerarChave(int aCodigoUf, int aCodigoNumerico, int aModelo, int aSerie, int aNumero,
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_GerarChave(getLibHandler(), aCodigoUf, aCodigoNumerico, aModelo,
    ...
    public String obterCertificados() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ObterCertificados(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
        return processResult(buffer, bufferLen);
    }
    ...
    public String getPath(TipoPathNFe tipo) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_GetPath(getLibHandler(), tipo.asInt(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String getPathEvento(String aCodEvento) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_GetPathEvento(getLibHandler(), toUTF8(aCodEvento), buffer, bufferLen);
        checkResult(ret);
    ...
    public String statusServico() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_StatusServico(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    public String consultar(String eChaveOuNFe, boolean AExtrairEventos) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Consultar(getLibHandler(), toUTF8(eChaveOuNFe), AExtrairEventos, buffer, bufferLen);
        checkResult(ret);
    ...
    public String consultarRecibo(String aRecibo) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ConsultarRecibo(getLibHandler(), toUTF8(aRecibo), buffer, bufferLen);
        checkResult(ret);
    ...
    public String consultaCadastro(String cUF, String nDocumento, Boolean nIE) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ConsultaCadastro(getLibHandler(), toUTF8(cUF), toUTF8(nDocumento), nIE, buffer, bufferLen);
        checkResult(ret);
    ...
    public String inutilizar(String aCNPJ, String aJustificativa, int ano, int modelo, int serie,
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Inutilizar(getLibHandler(), toUTF8(aCNPJ), toUTF8(aJustificativa), ano, modelo, serie,
    ...
    public String enviar(int aLote, boolean imprimir, boolean sincrono, boolean zipado) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Enviar(getLibHandler(), aLote, imprimir, sincrono, zipado, buffer, bufferLen);
        checkResult(ret);
    ...
    public String cancelar(String aChave, String aJustificativa, String aCNPJ, int aLote) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Cancelar(getLibHandler(), toUTF8(aChave), toUTF8(aJustificativa), toUTF8(aCNPJ), aLote, buffer, bufferLen);
        checkResult(ret);
    ...
    public String enviarEvento(int idLote) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_EnviarEvento(getLibHandler(), idLote, buffer, bufferLen);
        checkResult(ret);
    ...
    public String distribuicaoDFeporUltNSU(int acUFAutor, String aCNPJCPF, String eultNsu) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_DistribuicaoDFePorUltNSU(getLibHandler(), acUFAutor, toUTF8(aCNPJCPF), toUTF8(eultNsu), buffer, bufferLen);
        checkResult(ret);
    ...
    public String distribuicaoDFeporNSU(int acUFAutor, String aCNPJCPF, String aNSU) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_DistribuicaoDFePorNSU(getLibHandler(), acUFAutor, toUTF8(aCNPJCPF), toUTF8(aNSU), buffer, bufferLen);
        checkResult(ret);
    ...
    public String distribuicaoDFeporChave(int acUFAutor, String aCNPJCPF, String aChave) throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_DistribuicaoDFePorChave(getLibHandler(), acUFAutor, aCNPJCPF, aChave, buffer, bufferLen);
        checkResult(ret);
    ...
    public void enviarEmail(String aPara, String aChaveNFe, boolean aEnviarPDF, String aAssunto,
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_EnviarEmail(getLibHandler(), aPara, aChaveNFe, aEnviarPDF, aAssunto,
    ...
    public void enviarEmailEvento(String aPara, String aChaveEvento, String aChaveNFe, boolean aEnviarPDF,
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_EnviarEmailEvento(getLibHandler(), aPara, aChaveEvento, aChaveNFe, aEnviarPDF,
    ...
    public void imprimir(String cImpressora, int nNumCopias, String cProtocolo, Boolean bMostrarPreview, Boolean cMarcaDagua,
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_Imprimir(getLibHandler(), toUTF8(cImpressora), nNumCopias, toUTF8(cProtocolo), toUTF8(mostrarPreview),
                toUTF8(marcaDagua), toUTF8(viaConsumidor), toUTF8(simplificado));
        checkResult(ret);
    }

    public void imprimirPDF() throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ImprimirPDF(getLibHandler());
        checkResult(ret);
    }

    public void imprimirEvento(String eArquivoXmlNFe, String eArquivoXmlEvento) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ImprimirEvento(getLibHandler(), toUTF8(eArquivoXmlNFe), toUTF8(eArquivoXmlEvento));
        checkResult(ret);
    }

    public void imprimirEventoPDF(String eArquivoXmlNFe, String eArquivoXmlEvento) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ImprimirEventoPDF(getLibHandler(), toUTF8(eArquivoXmlNFe), toUTF8(eArquivoXmlEvento));
        checkResult(ret);
    }

    public void imprimirInutilizacao(String eArquivoXml) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ImprimirInutilizacao(getLibHandler(), toUTF8(eArquivoXml));
        checkResult(ret);
    }

    public void imprimirInutilizacaoPDF(String eArquivoXml) throws Exception {
        int ret = ACBrNFeLib.INSTANCE.NFE_ImprimirInutilizacaoPDF(getLibHandler(), toUTF8(eArquivoXml));
        checkResult(ret);
    }

    public void ConfigImportar(String eArqConfig) throws Exception {

        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigImportar(getLibHandler(), eArqConfig);
        checkResult(ret);
    ...
    public String ConfigExportar() throws Exception {
        ...
        int ret = ACBrNFeLib.INSTANCE.NFE_ConfigExportar(getLibHandler(), buffer, bufferLen);
        checkResult(ret);
    ...
    protected void UltimoRetorno(ByteBuffer buffer, IntByReference bufferLen) {
        ACBrNFeLib.INSTANCE.NFE_UltimoRetorno(getLibHandler(), buffer, bufferLen);
    }
}
